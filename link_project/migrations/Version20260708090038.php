 ...
 */
final class Version20260708090038 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE link');
        $this->addSql('CREATE TABLE link (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, full_url VARCHAR(2048) NOT NULL, short_code VARCHAR(255) NOT NULL, is_one_time BOOLEAN NOT NULL, expiration_date DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, last_used_at DATETIME DEFAULT NULL, visit_count INTEGER NOT NULL, user_id INTEGER NOT NULL, CONSTRAINT FK_36AC99F1A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
